(function () {
  ...
  function renderDesktopIcons() {
    desktopIconsEl.innerHTML = DESKTOP_ITEMS.map(function (item) {
      return '<div class="desktop-icon' + (state.selectedDesktop === item.id ? " selected" : "") + '" data-id="' + item.id + '"><div class="icon-image">' + iconMarkup(item.icon, 40) + '</div><div class="icon-label">' + formatDesktopIconTitle(item.title) + "</div></div>";
    }).join("");
